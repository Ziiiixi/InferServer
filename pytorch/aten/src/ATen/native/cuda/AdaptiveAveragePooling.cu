      ...
      case at::MemoryFormat::Contiguous: {
        ...
        AT_DISPATCH_FLOATING_TYPES_AND2(kHalf, kBFloat16,
            input_.scalar_type(), "adaptive_avg_pool2d_cuda", [&] {
              ...
              std::ofstream log_file("/home/zixi/workspace/log/adaptive_average_pool.txt", std::ios_base::app);
              if (log_file.is_open()) {
                log_file << "adaptive_average_pool execution time: " << excution_time << " ms" << std::endl;
                log_file.close();
              } else {
