    ...
    [&] {
      ...
      switch (memory_format) {
        ...
        case MemoryFormat::Contiguous: {
          ...
          std::ofstream log_file("/home/zixi/workspace/log/max_pool_forward_nchw.txt", std::ios_base::app);
          if (log_file.is_open()) {
            log_file << "max_pool_forward_nchw execution time: " << excution_time << " ms" << std::endl;
            log_file.close();
          } else {
