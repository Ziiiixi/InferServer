...
def load_kernel_info(model_name1, model_name2):
    ...
    if(model_name1 == model_name2):
        filename = f'/home/zixi/orion_bu/artifact_evaluation/fig7/coexe_small_models/kernel_groups/{model_name1}_groups.csv'
    
    else:
        filename = f'/home/zixi/orion_bu/artifact_evaluation/fig7/coexe_small_models/kernel_groups/{model_name1}_{model_name2}_groups.csv'
        
        if not os.path.exists(filename):
            # Check if the reversed filename exists
            filename = f'/home/zixi/orion_bu/artifact_evaluation/fig7/coexe_small_models/kernel_groups/{model_name2}_{model_name1}_groups.csv'
            if not os.path.exists(filename):
...
def load_contention_matrix(model_name1, model_name2):
    filename = ''
    if(model_name1 == model_name2):
        filename = f'/home/zixi/orion_bu/artifact_evaluation/fig7/coexe_small_models/contention_matrix/contention_matrix_{model_name1}.csv'
    
    else:
        filename = f'/home/zixi/orion_bu/artifact_evaluation/fig7/coexe_small_models/contention_matrix/contention_matrix_{model_name1}_{model_name2}.csv'
        if not os.path.exists(filename):
            # Check if the reversed filename exists
            filename = f'/home/zixi/orion_bu/artifact_evaluation/fig7/coexe_small_models/contention_matrix/contention_matrix_{model_name2}_{model_name1}.csv'
            if not os.path.exists(filename):
