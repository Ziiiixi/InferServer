...
// typedef struct cudnnBackend_record
// {
...
// 	cudnnBackend_record(cudnnHandle_t handle_arg, cudnnBackendDescriptor_t executionPlan_arg, cudnnBackendDescriptor_t varianPack_arg)
// 	{
// 		handle = handle_arg;
// 		executionPlan = executionPlan_arg;
// 		varianPack = varianPack_arg;
// 	};
...
union func_data
{
	...
	// cudnnBackend_record cudnnBackendRecord;
...
// extern cudnnStatus_t (*cudnn_backend_func)(cudnnHandle_t handle, const cudnnBackendDescriptor_t executionPlan, const cudnnBackendDescriptor_t varianPack);
